...
namespace model_hane_model_namespace {
...
class model_hane_model final : public model_base_crtp<model_hane_model> {
private:
  int N;
  int K;
  int D;
...
public:
  ~model_hane_model() {}
  model_hane_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_hane_model_namespace::model_hane_model";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_hane_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
              ...
              jacobian__>(-1, 1, lp__);
      {
        ...
        stan::model::assign(Sigma,
          stan::math::add(stan::math::multiply(gPg, Omega),
            stan::math::multiply(s2, I)), "assigning variable Sigma");
        ...
        lp_accum__.add(stan::math::multi_normal_lpdf<propto__>(gamma, g_mean,
                         g_sigma));
        ...
        lp_accum__.add(stan::math::log_determinant(W));
        current_statement__ = 22;
        lp_accum__.add(stan::math::multi_normal_lpdf<propto__>(
                         stan::math::multiply(W, y), mu, Sigma));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_hane_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_hane_model_namespace::model_hane_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_hane_model_namespace::profiles__;
}
#endif
#endif

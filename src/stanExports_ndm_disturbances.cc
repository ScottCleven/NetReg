...
#include "stanExports_ndm_disturbances.h"

RCPP_MODULE(stan_fit4ndm_disturbances_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ndm_disturbances")

...
#include "stanExports_nem_effects.h"

RCPP_MODULE(stan_fit4nem_effects_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_nem_effects")

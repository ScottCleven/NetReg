...
namespace model_nem_effects_namespace {
...
static constexpr std::array<const char*, 38> locations_array__ =
  ...
  " (in 'string', line 18, column 2 to column 30)",
  " (in 'string', line 21, column 2 to column 24)",
  " (in 'string', line 24, column 9 to column 10)",
  " (in 'string', line 24, column 12 to column 13)",
  ...
  " (in 'string', line 26, column 2 to column 32)",
...
class model_nem_effects final : public model_base_crtp<model_nem_effects> {
private:
  int N;
  int K;
...
public:
  ~model_nem_effects() {}
  model_nem_effects(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_nem_effects_namespace::model_nem_effects";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_nem_effects_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      sigma = stan::math::sqrt(s2);
      {
        ...
        stan::model::assign(mu,
          stan::math::multiply(W, stan::math::multiply(X, beta)),
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_nem_effects_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "s2", "rho"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"s2\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_nem_effects_namespace::model_nem_effects;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_nem_effects_namespace::profiles__;
}
#endif
#endif
